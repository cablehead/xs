...
class XS:
    ...
    def cat(follow: bool = False, pulse: Optional[int] = None, tail: bool = False,
            detail: bool = False, last_id: Optional[str] = None, limit: Optional[int] = None,
        ...
        Args:
            ...
            detail: include all frame fields in the output
        ...
        if not detail and not all:
            for frame in frames:
                frame.pop("context_id", None)
                frame.pop("ttl", None)

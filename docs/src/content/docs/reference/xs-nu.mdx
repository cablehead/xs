...
Append content to a topic. Wraps <Link to="/reference/cli#append">`xs append`</Link>.
...
Stream frames from the store. Wraps <Link to="/reference/cli#cat">`xs cat`</Link>.
...
Get the most recent frame for a topic. Wraps <Link to="/reference/cli#head">`xs head`</Link>.
...
Remove a frame by ID. Wraps <Link to="/reference/cli#remove">`xs remove`</Link>.
...
Retrieve a frame by ID. Wraps <Link to="/reference/cli#get">`xs get`</Link>.
...
Generate a new SCRU128 ID. Wraps <Link to="/reference/cli#scru128">`xs scru128`</Link>.
...
Unpack a SCRU128 ID into its component fields. Wraps <Link to="/reference/cli#unpack">`xs scru128 unpack`</Link>.
...
Pack component fields into a SCRU128 ID. Wraps <Link to="/reference/cli#pack">`xs scru128 pack`</Link>.
...
Retrieve content from Content-Addressable Storage by hash. Wraps <Link to="/reference/cli#cas">`xs cas`</Link>.
...
Store content in Content-Addressable Storage. Wraps <Link to="/reference/cli#cas-post">`xs cas-post`</Link>.
...
Import frames from a backup directory. Wraps <Link to="/reference/cli#import">`xs import`</Link>.

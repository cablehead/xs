...
The `xs.nu` module provides Nushell-friendly wrappers around the core `xs` CLI commands, enabling seamless pipeline integration and environment-aware operations. See <Link to="/reference/topics/">Topics</Link> for naming rules and wildcards.
...
- `count` - Number of frames to return (default: 1)

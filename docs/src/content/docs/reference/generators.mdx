...
Generators emit lifecycle events to track their state. For a complete overview of all topic suffixes, see <Link to="/reference/topic-suffixes/">Topic Suffixes</Link>.

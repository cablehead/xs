...
Handlers can use modules registered via `*.nu` topics. A handler sees the modules as they existed when it was registered. See <Link to="/reference/topics/#module-topics">Module Topics</Link> for details.

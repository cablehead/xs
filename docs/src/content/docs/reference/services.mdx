...
<Link to="/reference/topics/#module-topics">Module Topics</Link> for details.
...
Services share the unified lifecycle vocabulary documented in
<Link to="/reference/lifecycle/" />. In summary:
...
See <Link to="/reference/lifecycle/" /> for the full event list, the

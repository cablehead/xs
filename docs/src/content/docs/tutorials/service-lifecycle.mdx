...
This tutorial walks through every stage of a <Link to="/reference/services/">service</Link>
...
options, duplex communication, and return options. See
<Link to="/reference/lifecycle/" /> for the full event vocabulary that
...
<Link to="/reference/lifecycle/#compaction-algorithm" /> for the rules.
...
the dispatcher honors, see <Link to="/reference/lifecycle/" />.

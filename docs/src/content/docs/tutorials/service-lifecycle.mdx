...
description: Walk through the lifecycle of a cross.stream service -- spawn, auto-restart, hot reload, and terminate.
sidebar:
  order: 4
---
...
| `.shutdown` | The service loop has fully exited after a terminate        |

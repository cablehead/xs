...
Now you want to mark the first todo as complete. With event streams, you **cannot modify existing events**. Instead, you append a new event representing the completion:

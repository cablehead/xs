...
authoritative reference see the [lifecycle reference](../../reference/lifecycle/); for the
...
- [Lifecycle reference](../../reference/lifecycle/): the authoritative event list,
  state-transition table, threshold rule, and invariants.
- [Topics reference](../../reference/topics/): naming rules, hierarchy, the `xs.`
